...
TGAColor Model::diffuse(vec2 uvf) {
    ivec2 uv(uvf[0]*diffusemap_.get_width(), uvf[1]*diffusemap_.get_height());
    return diffusemap_.get(uv[0], uv[1]);
}

vec3 Model::normal(vec2 uvf) {
    ivec2 uv(uvf[0]*normalmap_.get_width(), uvf[1]*normalmap_.get_height());
...
float Model::specular(vec2 uvf) {
    ivec2 uv(uvf[0]*specularmap_.get_width(), uvf[1]*specularmap_.get_height());
